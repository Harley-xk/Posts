...
不过我简单调研下来发现很多第三方评论系统的 UI 真的是一言难尽...而且大多数还不支持 Markdown 格式的评论。后来选了个 UI 还算看得过去的 [Disquz](https://disqus.com/)，也是这个市场的巨头之一了。不过等博客架设起来之后才发现一个悲催的问题：**_它被墙了_**🤐。鉴于这里涉及到了敏感领域，所以被墙也可以理解吧，不过 Disquz 似乎也不支持 Markdown 评论。
